(* Lexer For Tiger'
   ...
   To give us the freedom to generate internal identifier names,
   all identifiers in user programs must not start with the underscore!
*)
...
let newline   = ('\013'* '\010')
let blank     = [' ' '\009' '\012']
let lowercase = ['a'-'z']   (* Not including underscore! *)
let uppercase = ['A'-'Z']
