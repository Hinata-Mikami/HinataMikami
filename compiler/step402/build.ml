...
let compiler_manifest = build_all [
  ...
  ocaml "../step35/lang.mli" ~rename:"lang_35";
  ocaml "../step36/lang.mli" ~rename:"lang_36";
  ocaml "../step37/lang.mli" ~rename:"lang_3";
  ocaml "lang.mli";
  ...
  ocaml "../step35/pp_ast.ml" ~rename:"pp_ast_35";
  ocaml "../step36/pp_ast.ml" ~rename:"pp_ast_36";
  ocaml "../step37/pp_ast.ml" ~rename:"pp_ast_3";
  ocaml "pp_ast.ml";
  ...
  ocaml "../step35/asm.mli" ~rename:"asm_35";
  ocaml "../step36/asm.mli" ~rename:"asm_3";
  ocaml "asm.mli";
  ...
  ocaml "../step35/asm.ml" ~rename:"asm_impl_35";
  ocaml "../step36/asm.ml" ~rename:"asm_impl_3";
  ocaml "asm.ml";
  ocaml "../step22/code_gen.ml" ~rename:"code_gen_22";
  ocaml "../step23/code_gen.ml" ~rename:"code_gen_23";
  ocaml "code_gen_31.ml";  (* re-implemented *)
  ocaml "../step32/code_gen.ml" ~rename:"code_gen_32";
  ocaml "../step34/code_gen.ml" ~rename:"code_gen_34";
  ocaml "../step35/code_gen.ml" ~rename:"code_gen_35";
  ocaml "../step36/code_gen.ml" ~rename:"code_gen_36";
  ocaml "../step37/code_gen.ml" ~rename:"code_gen_3";
  ocaml "code_gen.ml";
  ocaml "../step35/globals.ml";
  ...
  ocaml "../step35/compiler.ml" ~rename:"compiler_35";
  ocaml "../step36/compiler.ml" ~rename:"compiler_36";
  ocaml "../step37/compiler.ml" ~rename:"compiler_3";
  ocaml "compiler.ml";
 ...
 *)
  ...
  "../step37/test_script_1.ml";
  "../step37/test_script_2.ml";
  "test_script.ml";
  "test_script_1.ml";
  ]
